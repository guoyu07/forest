...
if ( !function_exists( 'madeleine_custom_header_setup' ) ) {
  function madeleine_custom_header_setup() {
    ...
    //       'description'   => _x( 'Madeleine', 'header image description', 'madeleine' )
    //     )
    //   )
    // );
  }
...
if ( !function_exists( 'madeleine_header_style' ) ) {
...
if ( !function_exists( 'madeleine_admin_header_style' ) ) {
...
if ( !function_exists( 'madeleine_admin_header_image' ) ) {
