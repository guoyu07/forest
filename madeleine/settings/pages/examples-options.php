...
if ( !function_exists( 'madeleine_default_input_settings' ) ) {
...
if ( !function_exists( 'madeleine_initialize_input_examples' ) ) {
...
if ( !function_exists( 'madeleine_input_examples_callback' ) ) {
...
if ( !function_exists( 'madeleine_input_element_callback' ) ) {
...
if ( !function_exists( 'madeleine_textarea_element_callback' ) ) {
...
if ( !function_exists( 'madeleine_checkbox_element_callback' ) ) {
...
if ( !function_exists( 'madeleine_radio_element_callback' ) ) {
...
if ( !function_exists( 'madeleine_select_element_callback' ) ) {
...
if ( !function_exists( 'madeleine_validate_input_examples' ) ) {
