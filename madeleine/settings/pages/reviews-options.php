...
if ( !function_exists( 'madeleine_default_reviews_options' ) ) {
...
if ( !function_exists( 'madeleine_rating_callback' ) ) {
...
if ( !function_exists( 'madeleine_maximum_rating_callback' ) ) {
...
if ( !function_exists( 'madeleine_price_callback' ) ) {
...
if ( !function_exists( 'madeleine_maximum_price_callback' ) ) {
